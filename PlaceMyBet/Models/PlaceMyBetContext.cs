...
namespace PlaceMyBet.Models
{
    public class PlaceMyBetContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Usuario>().HasData(new Usuario(1, "Alex", "Montalvo", 50, 1.5));
            modelBuilder.Entity<CasaApuestas>().HasData(new CasaApuestas(1, 4000, "Caixa", 12345678, "alexmontalvo@gmail.com"));
            ...
            modelBuilder.Entity<Apuesta>().HasData(new Apuesta(1, "over", 4000, 1.5, "alexmontalvo@gmail.com"));
        }
    }
}